  ...
  return (
    <main className="w-screen h-screen pt-5 flex items-top justify-center">
      <div className="w-[80%] h-[70%] flex items-center border-white">
        ...
        <div className="w-1/2 h-fit relative border p-4 lg:pr-8  divide-y divide-gray-800 divide-solid">
          <h1 className="py-2 lg:py-6 lg:text-5xl">
            {" "}
            {"> "} Meharwan Singh{" "}
            <span className="text-gray-500">( @ThePIkachuDev )</span>
          </h1>
          <h2 className="py-2 lg:py-6 lg:text-4xl text-gray-300">
            {" "}
            {"-  "} Programmer , linux user , 18yrs old , HackClubber{" "}
          </h2>

          <h3 className="py-2 lg:py-6 lg:text-3xl text-neutral-400 text-[15px] tracking-wide lg:tracking-wider">
          ...
          <div className="contact_links flex gap-1 ">
            <a
          ...
          <div className="border h-30 flex ">
            <motion.div className="bar h-full w-10 bg-red-300 "></motion.div>
